 ...
 * org.springframework.web.multipart.MultipartFile; import java.io.File; import
 * java.util.UUID; import java.util.function.BiFunction; import
 ...
 * 
 * @Component("filemgr") public class FileProxy extends Proxy{
 * 
 ...
 * savedFile = makeFile(uploadPath,
 * fname+"-"+UUID.randomUUID().toString()+"."+extension); try {
 * m.transferTo(savedFile); } catch (Exception e) { e.printStackTrace(); } } }
 * 
 * public String getFolder() { return currentDate().replace("-",
 * File.separator); } }
 */